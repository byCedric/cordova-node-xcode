...
function pbxFile(filepath, opt) {
    ...
    if (opt.customFramework == true) {
        ...
        this.dirname = pbxFile.normalizePath(path.dirname(filepath));
    }

    this.path = pbxFile.normalizePath(defaultPath(this, filepath));
...
/**
 * Normalize the file path to a posix path.
 * XCode only works in MacOS and MUST only contain posix paths.
 *
 * @param {string} filePath
 */
pbxFile.normalizePath = function (filePath = '') {
